...
def build_model(input_data):
    ...
    load_model = pickle.load(open('DAT_model.pkl', 'rb'))
...
st.markdown("""
# Bioactivity Prediction App (Dopamine Active Transporters)

This app allows you to predict the bioactivity towards inhibting the `Dopamine Active Transporters`. `Dopamine Active Transporter` is a membrane-spanning protein that pumps the neurotransmitter dopamine out of the synaptic cleft back into cytosol (source: Wikipedia).
""")
